...
from .fred_test_utils import returned_ok, make_time_string
...
def get_a_series_method_works(
    ...
    returned_ok_params['check_union'] = ('series', 'seriess',)
...
#            'units': 'log',
    ...
    returned_ok_params['expected'] = params
    returned_ok_params['check_union'] = ('df', 'observations',)
...
#            'search_type': 'series_id',
    ...
    returned_ok_params['expected'] = params
    returned_ok_params['check_union'] = ('seriess', 'series',)
    return returned_ok(**returned_ok_params)
...
#            'tag_search_words': ('', '',),
    ...
    returned_ok_params['observed'] = fred.series_stack['get_related_tags_for_series_search']
    params.pop('search_words')
